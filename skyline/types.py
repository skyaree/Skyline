...
from skylinetl.tl.functions.account import UpdateNotifySettingsRequest
...
class Module:
    ...
    @property
    def skyline_commands(self) -> typing.Dict[str, Command]:
        """List of commands that module supports"""
        return get_commands(self)
    @property
    ...
    @property
    def skyline_inline_handlers(self) -> typing.Dict[str, Command]:
        """List of inline handlers that module supports"""
        return get_inline_handlers(self)
    @property
    ...
    @property
    def skyline_callback_handlers(self) -> typing.Dict[str, Command]:
        """List of callback handlers that module supports"""
        return get_callback_handlers(self)
    @property
    ...
    @property
    def skyline_watchers(self) -> typing.Dict[str, Command]:
        """List of watchers that module supports"""
        return get_watchers(self)
    @commands.setter
    def commands(self, _):
        pass
    @skyline_commands.setter
    def skyline_commands(self, _):
        pass
    @inline_handlers.setter
    def inline_handlers(self, _):
        pass
    @skyline_inline_handlers.setter
    def skyline_inline_handlers(self, _):
        pass
    @callback_handlers.setter
    def callback_handlers(self, _):
        pass
    @skyline_callback_handlers.setter
    def skyline_callback_handlers(self, _):
        pass
    @watchers.setter
    def watchers(self, _):
        pass
    @skyline_watchers.setter
    def skyline_watchers(self, _):
        pass
    async def animate(
        self,
    ...
    async def _decline(
        ...
        self._db.set(
            "skyline.main",
            "declined_joins",
            list(set(self._db.get("skyline.main", "declined_joins", []) + [channel.id])),
        )
        event.status = False
        event.set()
        await call.edit(
            ...
            photo="https://raw.githubusercontent.com/coddrago/assets/refs/heads/main/skyline/declined_jr.png",
        )
    async def request_join(
        ...
        if isinstance(channel, ChannelForbidden):
            ...
            return False
        if channel.id in self._db.get("skyline.main", "declined_joins", []):
            if assure_joined:
                raise LoadError(
        ...
        await self.inline.bot.send_photo(
            self.tg_id,
            "https://raw.githubusercontent.com/coddrago/assets/refs/heads/main/skyline/join_request.png",
            caption=(
        ...
        self.skyline_wait_channel_approve = (
            self.__class__.__name__,
            channel,
            reason,
        )
        ...
        await event.wait()
        with contextlib.suppress(AttributeError):
            delattr(self, "skyline_wait_channel_approve")
    ...
    async def import_lib(
        ...
        *,
        ...
        code = code.text
        if re.search(r"# ?scope: ?skyline_min", code):
            ver = tuple(
                map(
                    int,
                    re.search(r"# ?scope: ?skyline_min ((\d+\.){2}\d+)", code)[1].split(
                        "."
                    ),
                )
            )
        ...
        module = f"skyline.libraries.{url.replace('%', '%%').replace('.', '%d')}"
        ...
        if (
            ...
            and self._db.get("skyline.main", "stats", True)
            and url is not None
