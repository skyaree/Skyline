...
from skylinetl.errors.rpcerrorlist import InputUserDeactivatedError, YouBlockedUserError
...
class InlineManager(
    ...
    :type client: skyline.tl_cache.CustomTelegramClient
        ...
        try:
            ...
            try:
                m = await self._client.send_message(
                    self.bot_username, "/start skyline init"
                )
            except Exception:
