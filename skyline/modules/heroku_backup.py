    ...
    async def client_ready(self):
        if not self.get("period"):
            await self.inline.bot.send_photo(
                self.tg_id,
                photo="https://raw.githubusercontent.com/coddrago/assets/refs/heads/main/skyline/unit_alpha.png",
        ...
        self._backup_channel, _ = await utils.asset_channel(
            ...
            silent=True,
            archive=True,
            avatar="https://raw.githubusercontent.com/coddrago/assets/refs/heads/main/skyline/skyline_backups.png",
            _folder="skyline",
            invite_bot=True,
        )
                ...
                reply_markup=self.inline.generate_markup(
                    [
                        [
                            {
                                "text": "↪️ Restore this",
                                "data": "skyline/backupall/restore/confirm",
                            }
                        ]
                    ]
                ),
    ...
    async def restore(self, call: BotInlineCall):
        ...
        if call.data == "skyline/backupall/restore/confirm":
            await utils.answer(
                ...
                reply_markup={
                    "text": "✅ Yes",
                    "data": "skyline/backupall/restore",
                },
            )
            return
